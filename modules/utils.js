...
// No coordinate at all is not the same as an approximate one - say nothing rather than
// claim a precision we do not have. trustLine filters empty parts out.
export function precisionLabel(r){if(rowLat(r)==null||rowLon(r)==null)return ''; return isExactCoordinate(r)?tr('exactLocation'):tr('approxLocation')}
