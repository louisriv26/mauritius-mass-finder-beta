...
const CACHE_NAME='mmf-v24-24-9';
const CORE=['./','index.html','styles.css','app.js','version.json','manifest.json','data/masses.json','fallback-data.js','icon.svg','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-192.png','icons/icon-maskable-512.png'];
