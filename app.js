...
function nearSortKey(r){
  ...
  // v24.9: hard precedence guard. A Mass today/tomorrow within a reasonable nearby radius
...
initModals();
window.MMF = {render, filtered, getData:()=>DATA, setLang, version:APP_VERSION, buildMapsQuery, siteDisplayName, searchMatchesRow, searchKey, searchScore, isNearMeIntent, compareNearResults, nearSortKey, buildSuggestions, isVigilMass, vigilStatus, isSundayFilterMatch, checkForUpdate};
loadData();
})();
