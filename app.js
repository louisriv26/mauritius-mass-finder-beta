...
'use strict';
const APP_VERSION='27.2.18';
const CACHE_NAME='mmf-v27-2-18';
...
function render(){compute(); renderStatic(); renderChips(); renderTags(); renderNav(); renderNext(); renderResults(); renderMore(); renderFooter(); renderInstallOnboarding(); $('#resultsHead').hidden=state.mode==='more'; $('#searchBox').classList.toggle('hasText',!!state.query);}
...
window.MMFDiagnostics={runSearchDiagnostics,runDateDiagnostics,runRankingDiagnostics,runStateDiagnostics,runDeepLinkDiagnostics,activeFilterCount,isDayFilterActive,isTimeFilterActive,parseUserIntent,removeQueryIntent,removeNearIntentFromQuery,getVisibleResults};
