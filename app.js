...
function isExactCoord(r){ const p=String(r.coordinate_precision||'').toLowerCase(); const c=Number(r.coordinate_confidence||0); return p === 'exact_door' && c >= 0.9; }
