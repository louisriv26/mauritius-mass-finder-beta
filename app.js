...
document.addEventListener('click', (ev)=>{ const wrap=$('headerOverflowMenu')?.closest('.overflowMenuWrap'); if(wrap && !wrap.contains(ev.target)) closeHeaderMenu(false); });
